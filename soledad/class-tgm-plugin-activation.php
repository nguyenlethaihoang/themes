            ...
            <div class="tgmpa wrap">
				...
				<?php if ( 'yes' != $penci_dismis_notes ): ?>
                    ...
                    <div class="penci-plugins-notice">
                        <h3 style="font-size: 20px; line-height: 1.3;"><?php _e( 'Please note that this theme does not require any plugin - you can pick plugins you want to use and activate it.<br>For normal sites, you just need to install 2 plugins "Penci Shortcodes & Performance" and "Elementor" is enough.<br>All other plugins are add-on features. Below is more detail about features of each plugin:', 'tgmpa' ); ?></h3>
                        <p class="penci-dplugins"><span
                                    class="penci-notice-head">Penci Shortcodes & Performance:</span> <?php esc_html_e( 'You should activate this plugin. It provide some shortcodes inside the editor & language shortcodes to help you can build multiple languages website. You need this plugin to optimize your site speed also.', 'tgmpa' ); ?>
                        </p>
                        <p class="penci-dplugins"><span
